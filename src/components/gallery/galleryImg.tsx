    ...
    <>
        ...
        <DetailImg>
          ...
          <DivContainer>
            ...
            <DivComment>
              ...
              {/* {users.posts.images.comment.map((item, index) => {
                return (
                  <>
                    {item.users.map((usr, idx) => {
                      return (
                        <CommentsDiv>
                          <div className='comments'>
                            <CommentImg src={usr.avatar} alt='' className='prof' />
                            <div className='user-info'>
                              <p className='username'>{usr.name} {usr.surname}</p>
                              <p className='data'>{}</p>
                            </div>
                          </div>
      ...
      <GalleryContainer>
        {users.map((item, index) => {
          return (
            <>
              {item?.posts?.images?.map((img, index) => {
                return (
                  <div
                    className='pics'
                    key={index}
                    onClick={() => getImg(img.size_s)}>
                    <img src={img.size_s} style={{ width: '100%' }} />
                    <Hover
                      name={item.user.name}
